    ...
    $.ajax({
        ...
        success:function(response){
            ...
            $.each(data, function (i) {
                ...
                html += '<div id=div' + data[i].id + ' class="col-md-12 grid-margin stretch-card">'
                html += '<div class="card">'
                ...
                html += '<h6 class="mb-0">'+data[i].profile['name']+'</h6>'
                ...
                html +='<p class="mb-0 text-success font-weight-bold">Attend Islamic  :<span style="color:black">'+data[i].education['attendIslamicServices']+'</span></p>'
