...
class UserEducationLocationContactForm(forms.ModelForm):
    class Meta:
        ...
        widgets = { 
            ...
            'EduSpezialization':Select(attrs={'id':'EduSpezialization','name':'EduSpezialization','class': 'required form-control'}),
            'workingas':Select(attrs={'id':'workingas','name':'workingas','class': 'required form-control'}),
            'workingwith':Select(attrs={'id':'workingwith','name':'workingwith','class': 'required form-control'}),
...
class UserPreferencesForm(forms.ModelForm):
    class Meta:
        ...
        widgets = { 
            ...
            'EduSpezialization': Select(attrs={'id':'EduSpezialization','name':'EduSpezialization','class': 'form-control'}),
            'workingwith': Select(attrs={'id':'workingwith','name':'workingwith','class': 'form-control'}),
            'workingas': Select(attrs={'id':'workingas','name':'workingas','class': 'form-control'}),
